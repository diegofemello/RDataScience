...
pacotes <- c(
  "tidyverse", "sf", "tmap", "rgdal", "rgeos", "adehabitatHR", "knitr",
  "kableExtra"
)
...
shoppings_sp_df <- SpatialPointsDataFrame(
  data = shoppings,
  coords = coordenadas_shoppings,
  proj4string = CRS("+proj=longlat")
)
